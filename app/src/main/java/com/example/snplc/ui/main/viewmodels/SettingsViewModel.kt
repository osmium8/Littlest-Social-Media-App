...
class SettingsViewModel @ViewModelInject constructor(
    ...
    private val applicationContext: Context, // for string resources
    private val dispatcher: CoroutineDispatcher = Dispatchers.Main // for testing
) : ViewModel() {
    ...
    /** use viewModel to survive screen rotation */
